                ...
                <?php if(is_array($element)): ?>
                    <?php $__currentLoopData = $element; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page => $url): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if($page == $paginator->currentPage()): ?>
                            <li class="text-blue-600 mx-2 active" aria-current="page"><span><?php echo e($page); ?></span></li>
                        <?php else: ?>
                            <li class="mx-2"><a href="<?php echo e($url); ?>"><?php echo e($page); ?></a></li>
                        <?php endif; ?>
...
<?php endif; ?>
<?php /**PATH /var/www/html/ForeverLiving/resources/views/vendor/pagination/default.blade.php ENDPATH**/ ?>